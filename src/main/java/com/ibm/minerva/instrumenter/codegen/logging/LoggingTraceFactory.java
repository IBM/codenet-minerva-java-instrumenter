...
public final class LoggingTraceFactory implements TraceGeneratorFactory {
    
    private static final Logger logger = LoggingUtil.getLogger(LoggingTraceFactory.class);
    
    public LoggingTraceFactory() {}
